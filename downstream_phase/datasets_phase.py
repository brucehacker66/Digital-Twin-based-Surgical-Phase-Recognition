...
from datasets.phase.Cholec80_phase_3depth import PhaseDataset_Cholec80_3depth
from datasets.phase.Cholec80_phase_1mask_2depth import PhaseDataset_Cholec80_1mask_2depth
...
def build_dataset(is_train, test_mode, fps, args):
    ...
    if args.data_set == "Cholec80":
        ...
        if args.channel_type == "pure_depth":
        ...
        elif args.channel_type == "1mask_2depth":
            dataset = PhaseDataset_Cholec80_1mask_2depth(
                anno_path=anno_path,
                data_path=args.data_path,
                mode=mode,
                data_strategy=args.data_strategy,
