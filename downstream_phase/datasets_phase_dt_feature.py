...
from datasets.phase.Cholec80_phase_dt_feature import PhaseDataset_Cholec80_dt_feature

def build_dataset_dt_feature(is_train, test_mode, fps, args):
    ...
    if args.data_set == "Cholec80":
        ...
        dataset = PhaseDataset_Cholec80_dt_feature(
            anno_path=anno_path,
