...
--sampling_rate 4 \
--eval \
--finetune /home/hao/dt_sam2/checkpoints/1mask2depth/mp_rank_00_model_states.pt \
--data_set Cholec80 \
--data_fps 1fps \
--output_dir /home/hao/dt_sam2/results/1mask_2depth/101-105_original \
--log_dir /home/hao/dt_sam2/results/1mask_2depth/101-105_original \
--num_workers 15 \
