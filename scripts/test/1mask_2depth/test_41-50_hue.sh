...
--data_set Cholec80 \
--data_fps 1fps \
--output_dir /mnt/disk0/haoding/Surgformer_results/1mask_2depth/results/41-50_hue \
--log_dir /mnt/disk0/haoding/Surgformer_results/1mask_2depth/results/41-50_hue \
--num_workers 15 \
