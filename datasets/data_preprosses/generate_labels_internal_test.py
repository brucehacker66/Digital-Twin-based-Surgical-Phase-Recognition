...
def main():
    ROOT_DIR = "/mnt/disk0/haoding/cholec80_82+_original"
    ...
    VIDEO_NAMES = ["video82.mp4", "video83.mp4", "video84.mp4"]
    # TEST_NUMBERS = np.arange(11,21).tolist()
    TRAIN_NUMBERS = np.array([])
    TEST_NUMBERS = np.array([82, 83, 84])
    frames_count = [69, 120, 96]
    count = 0
    ...
    test_save_dir = os.path.join(ROOT_DIR, 'labels', 'test_82+')
